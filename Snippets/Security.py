...
elasticube.add_default_rule('table_name', 'column_name', 'numeric')

# Add default rule for some values
elasticube.add_default_rule('table_name', 'column_name', 'numeric', members=['1', '2'])
...
elasticube.add_security_rule(groups, 'table_name', 'column_name', 'numeric', all_members=True)
