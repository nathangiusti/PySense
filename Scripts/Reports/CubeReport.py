...
elasticube_creator_dict = {}
elasticube_counter_dict = {}

for elasticube in elasticubes:
    elasticube_counter_dict[elasticube.get_title()] = 0
    elasticube_creator_dict[elasticube.get_title()] = elasticube.get_creator().get_email()
...
with open(report_name, "w") as out_file:
    out_file.write("cube,creator,num dashboards\n")
    for key, value in elasticube_counter_dict.items():
        out_file.write("{},{},{}\n".format(key, elasticube_creator_dict[key], value))
